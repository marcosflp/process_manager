...
rules.add_perm('core.list_process', is_admin_user | is_manager_user | is_publisher_user)
rules.add_perm('core.view_process', is_admin_user | is_manager_user | is_process_member)
